    ...
    <div className="space-y-1">
      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          <div className="space-y-0.5">
            <div className="px-3 py-2 rounded-lg bg-white/15 flex items-start gap-2">
              <div className="w-1 min-h-[36px] rounded-full bg-[var(--aiox-blue)] flex-shrink-0" />
            ...
            <div className="px-3 py-2 rounded-lg hover:bg-white/5 flex items-start gap-2">
              <div className="w-1 min-h-[36px] rounded-full bg-[var(--aiox-gray-muted)] flex-shrink-0" />
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-0.5">
        ...
        <div>
          ...
          <div className="space-y-0.5">
            <div className="px-3 py-2 rounded-lg hover:bg-white/5 flex items-start gap-2">
              <div className="w-1 min-h-[36px] rounded-full bg-[var(--color-status-success)] flex-shrink-0" />
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-0.5">
